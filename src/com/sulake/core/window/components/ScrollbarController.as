package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1109:String = "increment";
      
      private static const const_481:String = "slider_bar";
      
      private static const const_1108:String = "decrement";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_481:
               if(param2.type == WindowNotifyEvent.const_216)
               {
                  if(!var_584)
                  {
                     if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_419)
         {
            if(var_19 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_765) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_481) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_870 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_870 != null)
         {
            _loc1_ = findParentByName(var_870) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_870) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1109)
            {
               if(var_19)
               {
                  var_584 = true;
            ...
            else if(param2.name == ScrollbarController.const_1108)
            {
               if(var_19)
               {
                  var_584 = true;
            ...
            else if(param2.name == ScrollbarController.const_765)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_481).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_808)
         {
