package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1082:String = "content";
      
      private static const const_1081:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1558 == null)
         {
            var_1558 = findChildByTag(TabContextController.const_1082) as IWindowContainer;
         }
         return var_1558;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_892 == null)
         {
            var_892 = findChildByTag(TabContextController.const_1081) as ITabSelectorWindow;
            if(var_892 != null)
            {
