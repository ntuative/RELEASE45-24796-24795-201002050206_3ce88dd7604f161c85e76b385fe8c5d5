package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_338:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_47))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_338)
         {
            var_338 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_338)
            {
               var_338.addEventListener(WindowEvent.const_243,scrollBarEventProc);
               var_338.addEventListener(WindowEvent.const_207,scrollBarEventProc);
            }
         }
         return var_338;
      }
      ...
      override public function dispose() : void
      {
         if(var_338)
         {
            var_338.removeEventListener(WindowEvent.const_243,scrollBarEventProc);
            var_338.removeEventListener(WindowEvent.const_207,scrollBarEventProc);
            var_338 = null;
         }
         if(var_842)
         {
      ...
      {
         if(param1.type == WindowEvent.const_243)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_207)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_842)
         {
            var_842 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_842;
      }
