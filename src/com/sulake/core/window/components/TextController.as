package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2312:Rectangle = new Rectangle();
       
      
      protected var var_195:Boolean;
      
      protected var var_58:TextMargins;
      
      protected var var_501:String = "none";
      
      protected var var_588:Number;
      
      protected var var_346:Number;
      ...
      {
         var_58 = new TextMargins(0,0,0,0,setTextMargins);
         var_195 = false;
         var_588 = 0;
         var_346 = 0;
         if(_field == null)
      ...
      {
         param1.var_58.dispose();
         param1.var_58 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_588 * maxScrollH,var_346 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_711)
         {
            context.removeLocalizationListener(var_299,this);
         }
         if(var_58 != null)
         {
            var_58.dispose();
      ...
      {
         var_588 = param1;
         _field.scrollH = var_588 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_299 = param1;
         if(var_299.charAt(0) == "$" && var_299.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_299.slice(2,var_299.indexOf("}")),this);
            var_711 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_195)
         {
            if(param2.type == WindowNotifyEvent.const_200)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_58.dispose();
            var_58 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_377,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_38,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_377,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_631,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_631,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("margin_left",var_58.left,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("margin_top",var_58.top,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("margin_right",var_58.right,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_58.bottom,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("auto_size",var_501,PropertyStruct.STRING,var_501 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_38,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_38,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_38,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_38,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_631,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_346 = var_346;
         _loc1_.var_58 = var_58.clone(_loc1_.setTextMargins);
         _loc1_.var_501 = var_501;
         _loc1_.var_711 = var_711;
         return _loc1_;
      }
