package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1002:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1377:Boolean = true;
      
      protected static const const_1001:String = "auto_arrange_items";
      ...
      protected var var_81:Number;
      
      protected var var_1328:Boolean = false;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_713:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_81 = 0;
         var_59 = 0;
         _horizontal = param2 == WindowType.const_307;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_150 = var_712 || !testParamFlag(WindowParam.const_14);
         _container = _context.create("_CONTAINER","",WindowType.const_277,WindowStyle.const_262,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_350,containerEventHandler);
      ...
      {
         return new Rectangle(var_503 * maxScrollH,var_504 * maxScrollV,width,height);
      }
      
      public function get maxScrollH() : int
      {
         var _loc1_:int = var_81 - width;
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_350,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != var_503)
         {
            ...
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_53);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1001,var_713,PropertyStruct.const_38,var_713 != const_1377));
         _loc1_.push(new PropertyStruct(const_1002,var_502,PropertyStruct.const_38,var_502 != const_1378));
         _loc1_.push(new PropertyStruct(const_999,var_1061,PropertyStruct.const_38,var_1061 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_999:
                  ...
                  break;
               case const_1001:
                  var_713 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(_horizontal)
         {
            param1.x = var_81 + (numListItems > 0 ? _spacing : 0);
            var_81 = param1.rectangle.right;
            _container.width = var_81;
         }
         else
         {
            if(autoArrangeItems)
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_453,param1);
            }
            else
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(var_502)
                     {
                        ...
                        var_81 = _loc3_ > var_81 ? Number(_loc3_) : Number(var_81);
                     }
                  }
                  _loc4_++;
               }
