package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_43:DisplayObjectContainer;
      
      private var _disposed:Boolean;
      
      private var var_676:ISkinContainer;
      
      private var var_1394:Rectangle;
      ...
      private var var_270:Rectangle;
      
      private var var_1395:Point;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_530 = new Array();
         var_1395 = new Point();
         var_1394 = new Rectangle();
         var_270 = new Rectangle();
         var_271 = new Dictionary(true);
         var_676 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_271[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_270.x = _loc3_.dirty.x;
               var_270.y = _loc3_.dirty.y;
               var_270.width = _loc3_.dirty.width;
               var_270.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_270);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_540,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_271[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_271[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_530 = null;
            for(_loc1_ in var_271)
            {
               delete var_271[_loc1_];
            }
            var_271 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1395,var_1394))
            {
               if(param2.render(param1,var_1395,var_1394))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_676);
            var_271[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_540,windowDisposedCallback);
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_53);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_270.x = param2.x - param1.x;
            var_270.y = param2.y - param1.y;
            var_270.width = param2.width;
            var_270.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_14))
            {
               while(param1.testParamFlag(WindowParam.const_14))
               {
                  ...
                  var_270.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_270,WindowRedrawFlag.const_224);
