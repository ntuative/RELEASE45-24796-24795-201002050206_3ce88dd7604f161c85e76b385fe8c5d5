package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_894:uint = 256;
      
      protected static var var_594:uint = 0;
      
      protected static var var_350:uint = 0;
      
      public static const const_838:uint = 2;
      
      public static const const_1580:uint = 128;
      
      public static const const_1463:uint = 64;
      
      public static const const_537:uint = 4;
      
      public static const const_1317:uint = 0;
      
      public static const const_1201:uint = 16;
      
      public static const const_592:uint = 1;
      
      public static const const_1193:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_587:Boolean;
      
      protected var var_1557:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_838:
               ...
               break;
            case GraphicContext.const_1193:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1201:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_537:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_894:
               break;
            case GraphicContext.const_1317:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_587)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_350 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_148 = new Sprite();
            var_148.name = this.name + " - Child Container";
            var_148.mouseEnabled = false;
            addChild(var_148);
         }
         return var_148;
      }
         ...
         if(var_587)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_350 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1557,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1557,16777215);
                  }
                  var_350 += bitmap.width * bitmap.height * 4;
               }
