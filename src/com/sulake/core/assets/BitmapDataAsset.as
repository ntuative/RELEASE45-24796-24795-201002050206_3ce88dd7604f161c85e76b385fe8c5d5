   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_917 = BitmapDataAsset(param1).var_917;
            var_916 = BitmapDataAsset(param1).var_916;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_917 = _loc4_ == "1" || _loc4_ == "com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer";
                  break;
               case "flipV":
                  var_916 = _loc4_ == "1" || _loc4_ == "com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer";
                  break;
            }
            _loc2_++;
         }
