package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_947:String = "AssetLibraryReady";
      
      public static const const_1274:String = "AssetLibraryUnloaded";
      
      public static const const_366:String = "AssetLibraryLoaded";
      
      public static const const_1325:String = "AssetLibraryLoadError";
      ...
      private var var_13:LibraryLoader;
      ...
      private var var_450:Boolean = true;
      
      private var var_320:Class;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_382)
         {
            _loc4_ = AssetTypeDeclaration(var_382[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_381)
         {
            _loc2_ = var_381[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_381[_loc1_];
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_451 = _loc2_.manifest.copy();
         var_320 = _loc2_.resource;
         if(var_450)
         {
            AssetLibrary.fetchLibraryContents(this,var_451,var_320);
         }
         var_277 = true;
         dispatchEvent(new Event(AssetLibrary.const_366));
         dispatchEvent(new Event(AssetLibrary.const_947));
         if(var_450)
         {
            var_13.dispose();
            var_13 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_381[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_15,assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_767,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_382.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_382[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      {
         return param1 < var_321.length ? getAssetByName(var_321[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1325));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_382[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_647[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(var_13 != null)
         {
            if(var_13.hasDefinition(param1))
            {
               _loc2_ = var_13.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  var_647[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_13 == null)
            {
               var_13 = new LibraryLoader(var_1331);
               var_13.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,libraryLoadedHandler);
               var_13.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            }
            var_450 = param2;
            _file = param1.url;
            var_13.load(param1,param3);
         }
         return var_13;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_451.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_320[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_381[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_15:
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_321.splice(var_321.indexOf(_loc2_),1);
      ...
      public function loadFromArchive(param1:URLRequest, param2:LoaderContext = null) : LibraryLoader
      {
         if(!(_file == param1.url && var_277))
         {
            ...
            var_13 = new ZipLoader(var_1331);
            var_13.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,archiveLoadedHandler);
            var_13.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            var_13.addEventListener(ProgressEvent.PROGRESS,onLoadProgress);
            var_450 = true;
            _file = param1.url;
            var_13.load(param1,param2);
         }
         return var_13;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_382[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_320 != null ? false : false;
      }
   }
}
