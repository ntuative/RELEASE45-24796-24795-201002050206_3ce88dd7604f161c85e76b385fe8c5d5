package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1054:LoaderContext;
      
      protected var var_28:Array;
      
      protected var var_500:Array;
      
      private var var_594:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_28 = new Array();
         var_500 = new Array();
         var_1054 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_344 = new AssetLibrary("lib-" + var_594++);
         var_28.push(var_344);
      }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_594++);
         var_500.push(_loc4_);
