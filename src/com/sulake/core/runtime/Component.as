package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1456:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_948:uint = 4;
      ...
      protected var var_171:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1063 = param2;
         var_171 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_171.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_886 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_886);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1063 & const_948)
         {
            if(_loc3_ == 0)
            {
               if(var_171.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_171.getStructByIndex(_loc8_);
