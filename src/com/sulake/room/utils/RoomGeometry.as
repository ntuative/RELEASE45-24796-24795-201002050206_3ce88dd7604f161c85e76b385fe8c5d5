package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_783:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_76 = new Vector3d();
         var_977 = new Vector3d();
         var_1467 = 1;
         var_1466 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1468 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            var_75.assign(_loc23_);
            _y.assign(_loc24_);
            var_76.assign(_loc25_);
         }
         else
         {
            var_75.assign(_loc18_);
            _y.assign(_loc19_);
            var_76.assign(_loc20_);
         }
      }
      
      public function set z_scale(param1:Number) : void
      {
         if(var_388 != param1 * var_1468)
         {
            var_388 = param1 * var_1468;
            ++var_70;
         }
      }
      ...
      {
         if(var_389 != param1 * var_1467)
         {
            var_389 = param1 * var_1467;
            ++var_70;
         }
      }
      ...
      {
         if(var_391 != param1 * var_1466)
         {
            var_391 = param1 * var_1466;
            ++var_70;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_977.assign(_loc22_);
         }
         else
         {
            var_977.assign(_loc17_);
         }
         ++var_70;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_391;
         _loc2_.z *= var_388;
         var _loc3_:Number = Vector3d.method_1(_loc2_,var_977);
         if(_loc3_ < var_2319 || _loc3_ > var_2318)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.method_1(_loc2_,var_75);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_391;
            _loc2_.z *= var_388;
            _loc3_ = Vector3d.method_1(_loc2_,var_977);
         }
      ...
      {
         return new Vector3d(0 * var_389,0 * var_391,0 * var_388);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.method_1(param1,var_75);
         var _loc3_:Number = Vector3d.method_1(param1,_y);
         var _loc4_:Number = Vector3d.method_1(param1,var_76);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function get directionAxis() : IVector3d
      {
         return new Vector3d(var_76.x,var_76.y,var_76.z);
      }
      ...
      {
         if(param1 == null || var_76 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(var_76,param2);
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_177;
         var _loc6_:Number = -param1.y / var_177;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_75,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_389,0 * var_391,0 * var_388);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_76;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_389,param2.y * var_391,param2.z * var_388);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_389,param3.y * var_391,param3.z * var_388);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_389,param4.y * var_391,param4.z * var_388);
