package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_476:int = (const_474 + const_326) * const_77 + const_77;
       
      
      private var var_810:Number = 1;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_219 = new Array();
         var_661 = new Point();
         var_142 = const_476 + const_261;
         super(param1,param2,param3);
         var_2000 = param5;
         var_27 = param1.createWindow("chat_container","",HabboWindowType.const_39,HabboWindowStyle.const_20,HabboWindowParam.const_23,new Rectangle(0,0,200,var_142 + RoomChatHistoryPulldown.const_52),null,0) as IWindowContainer;
         var_27.background = true;
         var_27.color = 33554431;
         var_27.tags.push("room_widget_chat");
         var_328 = param1.createWindow("chat_contentlist","",HabboWindowType.const_913,HabboWindowStyle.const_23,0 | 0,new Rectangle(0,0,200,var_142),null,0) as IItemListWindow;
         var_27.addChild(var_328);
         var_124 = param1.createWindow("chat_active_content","",HabboWindowType.const_39,HabboWindowStyle.const_23,HabboWindowParam.const_49,new Rectangle(0,0,200,var_142),null,0) as IWindowContainer;
         var_328.addListItem(var_124);
         var_22 = new RoomChatHistoryViewer(this,param1,var_27,param2);
         var_1998 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_483,onChatMessage);
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_620,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_142 = const_476 + const_261;
         var_27.height = var_142 + var_22.pulldownBarHeight;
         var_328.width = 0 - 0;
         var_328.height = var_142;
         var_124.width = 0 - 0;
         if(historyViewerActive())
         {
            var_124.height = getTotalContentHeight() + const_261;
         }
         else
         {
            var_124.height = var_142;
         }
         var_328.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      private function processBuffer() : void
      {
         ...
         while(var_57.length > const_1071 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_663 = getTimer() + const_738;
         }
         else
         {
            if(false && false)
            {
               var_554 = getItemSpacing(_itemList["-1"],var_57[0]);
            }
            else
            {
               var_554 = const_77;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_661.x) * var_810;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1223 && !historyViewerActive())
         {
            resetArea();
            var_1223 = false;
         }
      ...
      {
         return "chat_" + var_2000.toString() + "_item_" + (var_1999++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_483,onChatMessage);
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_620,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_466);
            if(_loc2_ == -1)
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1074 * const_1072;
            if(_loc2_ + var_662 > var_554)
            {
               _loc2_ = var_554 - var_662;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               var_810 = param1.scale / var_1476;
            }
         }
         if(param1.positionDelta != null)
         {
            var_661.x += param1.positionDelta.x / var_810;
            var_661.y += param1.positionDelta.y / var_810;
         }
         if(param1.rect != null)
         {
            if(var_22 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1998)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_466,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_466;
               if(_loc1_.aboveLevels > const_474 + const_326 + 2)
               {
                  _loc1_.aboveLevels = const_474 + const_326 + 2;
               }
               var_466 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_142 = param1 - 0;
         var_27.height = var_142 + RoomChatHistoryPulldown.const_52;
         if(var_22 != null)
         {
            var_22.containerResized(var_27.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc6_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_272,param1,param2);
         messageListener.processWidgetMessage(_loc6_);
         var _loc7_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_497,param1,param3,param4);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_326 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1073)
               {
