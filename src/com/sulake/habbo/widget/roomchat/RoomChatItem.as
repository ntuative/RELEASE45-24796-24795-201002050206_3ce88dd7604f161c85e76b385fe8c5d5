package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_477:int = 6;
      
      private static const const_329:int = 10;
      
      private static const const_1088:Number = 18;
      
      private static const const_1415:Number = 10;
      
      private static const const_1414:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1001,var_1000,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1001,var_1000,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1254 = param1.chatType;
         var_1001 = param1.userId;
         var_830 = param1.userName;
         var_1000 = param1.userCategory;
         _message = param1.text;
         var_1256 = param1.userX;
         var_188 = param1.userImage;
         var_1002 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_75,_y,width,_height);
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_33,onBubbleMouseDown);
            ...
            param1.addEventListener(WindowMouseEvent.const_82,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1254)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_229:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_233:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         var_89 = _window as IRegionWindow;
         var_89.background = true;
         var_89.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_89);
         ...
         if(var_188 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_402 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1002 != 0)
            {
               _loc30_ = uint(var_1002 >> 16 & 255);
               _loc31_ = uint(var_1002 >> 8 & 255);
               _loc32_ = uint(var_1002 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1254 == RoomWidgetChatUpdateEvent.const_229)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_830);
            }
            else if(var_1254 == RoomWidgetChatUpdateEvent.const_233)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_830);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_402;
            _loc20_.width = _loc20_.textWidth + const_477;
            _width += _loc20_.textWidth + const_477;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_329 + _loc20_.textWidth + const_477;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1001,var_1000,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1001,var_1000,_roomId,_roomCategory,param1);
      }
