package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1051:int = 18;
      
      private static const const_470:int = 20;
      ...
      private var var_318:Number = 1;
      
      private var _widget:RoomChatWidget;
      
      private var var_273:Boolean = false;
      
      private var var_211:Number = -1;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_137.state = RoomChatHistoryPulldown.const_176;
         ...
         var_36 = param2.createWindow("chatscroller","",HabboWindowType.const_884,HabboWindowStyle.const_23,0 | 0,new Rectangle(param3.rectangle.right - const_470,param3.y,const_470,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_273 ? Number(const_470) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_211 > 0 && param2)
         {
            if(var_1160)
            {
               if(Math.abs(param1 - var_211) <= const_979)
               {
                  return;
               }
               var_1160 = false;
            ...
            if(var_273)
            {
               ...
               _loc5_ = (param1 - var_211) / 0;
               _loc3_ = var_318 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_211;
               _loc7_ = true;
               _loc8_ = true;
               if(var_36.scrollV < 1 - const_1051 / var_36.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1421)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_273 && !var_1298)
         {
            ...
            var_137.state = RoomChatHistoryPulldown.const_287;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_137.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_176);
      }
