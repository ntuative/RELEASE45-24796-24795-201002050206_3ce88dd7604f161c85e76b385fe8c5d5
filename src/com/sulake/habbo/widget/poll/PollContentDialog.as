package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private var var_915:int = -1;
      
      private var var_611:Array;
      
      private var _window:IFrameWindow;
      
      private var var_269:IWindow;
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_29))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_611[var_915] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_269)
         {
            ...
            var_269 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_269.center();
            var_269.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_915;
         if(var_915 < var_611.length)
         {
            _loc1_ = var_611[var_915] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_611.length);
                  _loc2_.text = _loc6_;
               }
