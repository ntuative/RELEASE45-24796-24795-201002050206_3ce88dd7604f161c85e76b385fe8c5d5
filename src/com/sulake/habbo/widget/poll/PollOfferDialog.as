package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_224:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_716:String = "POLL_OFFER_STATE_CANCEL";
      ...
      private var var_29:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_29 = const_1192;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_640,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_29 = const_716;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_342,_id));
