package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1621:uint = 6710886;
      ...
      private const const_1622:String = "nutrition";
      ...
      private const const_1623:int = 158;
      
      private const const_1624:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_264:PetCommandTool;
      
      private const const_1618:uint = 11184810;
      
      private const const_1626:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc9_ = var_52.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc7_:* = [];
         var_52.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_95.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_95.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_264 == null)
         {
            var_264 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1180.getValue(var_707) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_264.showWindow(true);
            var_264.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_95.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_95.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1626,param1.experience,param1.experienceMax);
         updateStateElement(const_1620,param1.energy,param1.energyMax);
         updateStateElement(const_1622,param1.nutrition,param1.nutritionMax);
         ...
         if(var_264 && var_264.isVisible() && param1.isOwnPet)
         {
            var_264.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_95.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = var_52.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_264.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1623,const_1624,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1618);
         ...
         _loc5_.fillRect(_loc7_,const_1621);
         return _loc5_;
      }
