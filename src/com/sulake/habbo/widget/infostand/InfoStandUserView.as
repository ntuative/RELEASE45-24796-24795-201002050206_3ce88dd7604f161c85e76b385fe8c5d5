package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_95:IItemListWindow;
      
      private var var_984:TagListRenderer;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_984 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_52 = _window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         var_52.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         ...
         if(var_218 != null)
         {
            var_95 = var_218.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < var_52.numListItems)
            {
               _loc13_ = var_52.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
      ...
      {
         var _loc1_:IWindowContainer = var_95.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_95.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_95.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_95 == null || var_218 == null || var_52 == null)
         {
            return;
         }
         var_52.width = var_52.scrollableRegion.width;
         var_95.height = var_95.scrollableRegion.height;
         var_218.height = NaN;
         _window.width = Math.max(var_218.width,var_52.width);
      ...
      {
         var _loc2_:ITextWindow = var_95.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_95.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_95.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_95.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_984.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_95.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_95.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_95.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = var_52.getListItemByName(param1);
         if(_loc3_ != null)
         {
            _loc3_.visible = param2;
            var_52.arrangeListItems();
         }
      }
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = var_52.getListItemByName(param1) as IRegionWindow;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = var_52.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_856:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_882:
      ...
      {
         var _loc2_:ITextWindow = var_95.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_95.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_192:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_212:
      ...
      {
         var _loc3_:IWindowContainer = var_95.getListItemByName("image_and_badges_container") as IWindowContainer;
