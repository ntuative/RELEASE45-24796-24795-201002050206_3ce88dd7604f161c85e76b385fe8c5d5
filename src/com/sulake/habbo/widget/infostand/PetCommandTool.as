package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1627:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_1025 = new Map();
         var_343 = new Timer(const_1627);
         var_343.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var_1025.remove(param1);
         var_1025.add(param1,param2);
         if(param1 != var_707)
         {
            return;
         }
      ...
      {
         var _loc2_:Array = var_1025.getValue(var_707) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_410,var_707));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_524,var_707,var_2226 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1025.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_707);
         }
         else
         {
      ...
      private function createCommandWindow() : void
      {
         ...
         var_34.setParamFlag(WindowParam.const_64,true);
