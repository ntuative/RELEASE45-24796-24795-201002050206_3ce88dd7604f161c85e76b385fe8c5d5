package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1394:int = 5;
      
      private static const const_477:int = 16;
      
      private static const const_1034:int = 20;
      ...
      private var var_372:Number = 600;
      ...
      private var var_115:String = "";
      
      private var var_615:Timer;
      
      private var var_750:Timer;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_922 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1707 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1705 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_615 = new Timer(1000,1);
         var_615.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_750 = new Timer(5000,1);
         var_750.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_39,HabboWindowStyle.const_23,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_129,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_364,onWindowMoved);
         var_1117 = true;
         var_115 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1706 = _loc2_.width + const_477 + _loc6_.width + const_1034;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1033,_loc8_.width) + const_477);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_922 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_115 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_372);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_372);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_33,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_429);
