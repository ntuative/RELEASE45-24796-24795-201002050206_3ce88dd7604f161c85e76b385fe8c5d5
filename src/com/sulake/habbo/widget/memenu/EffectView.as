   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_875 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_168.duration);
               var_875.width = _loc2_ * var_372;
            }
            else
            {
               var_875.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_874 = _window.findChildByName("effect_hilite");
            var_874.visible = false;
         }
         var_873 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_875 = _window.findChildByName("loader_bar");
         if(var_875 != null)
         {
            var_372 = var_875.width;
            var_166.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_168.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_873 != null)
         {
            var_873.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_873.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
