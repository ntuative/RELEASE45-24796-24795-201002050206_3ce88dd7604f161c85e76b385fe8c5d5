package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_811:MeMenuSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_811.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_544 != null)
            {
               ...
               var_1438 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1438 * (Number(param1 - var_644) / (var_960 - var_644)));
      }
      ...
      {
         return param1 / var_1438 * (var_960 - var_644) + var_644;
      }
   }
}
