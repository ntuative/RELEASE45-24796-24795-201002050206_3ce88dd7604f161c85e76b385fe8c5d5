package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_467:BitmapData;
      
      private var var_1237:XML;
      
      private var var_279:IWindowContainer;
      
      private var var_395:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            _loc3_.width = var_467.width;
            _loc3_.height = var_467.height;
            var_395.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_467.width,var_467.height,true,0);
               _loc4_.bitmap.copyPixels(var_467,var_467.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_668.width,var_668.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_668,var_668.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_395.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_395.numGridItems)
         {
            return;
         }
         select(var_395.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_279 != null)
         {
            _loc2_ = var_279.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_467 = BitmapData(_loc3_.content);
         ...
         var_668 = BitmapData(_loc3_.content);
      }
