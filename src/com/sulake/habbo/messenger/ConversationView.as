package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_728:int = 100;
       
      
      private var var_1713:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_111 = param1;
         var_1387 = initButton("follow_friend",onFollowButtonClick,param2);
         var_42 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1713 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_111.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_111.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_585 || param3.type == Message.const_542 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_432.messages.length - const_728);
         _loc1_ = 0;
      ...
      {
         var _loc1_:Conversation = var_111.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_728 + const_1036)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_111.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_111.send(new FollowFriendMessageComposer(var_432.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_111.getButtonImage(param1);
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_111.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_111.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
