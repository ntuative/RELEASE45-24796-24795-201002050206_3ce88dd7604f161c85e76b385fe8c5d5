package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_729:uint = 11;
       
      
      private var var_203:LatencyTracker = null;
      
      private var var_204:PerformanceTracker = null;
      
      private var var_440:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_368:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_936:int = -1;
      
      private var var_1136:LagWarningLogger = null;
      
      private var var_758:IHabboWindowManager;
      ...
      private var var_159:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_204 = new PerformanceTracker();
         var_203 = new LatencyTracker();
         var_1136 = new LagWarningLogger();
         var_1135 = new Array(const_729);
         var _loc4_:int = 0;
         while(_loc4_ < const_729)
         {
            var_1135[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1257,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1374,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_558,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_615:
               trackLoginStep(HabboLoginTrackingStep.const_1237,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_194:
               trackLoginStep(HabboLoginTrackingStep.const_194);
               break;
            case HabboCommunicationEvent.const_153:
               trackLoginStep(HabboLoginTrackingStep.const_153);
               break;
            case HabboCommunicationEvent.const_143:
               setErrorContextFlag(2,0);
               trackLoginStep(HabboLoginTrackingStep.const_143);
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_204 != null)
            {
               var_204.connection = param1;
            }
            if(var_203 != null)
            {
               var_203.communication = _communication;
               var_203.connection = param1;
            }
         }
      }
      ...
      private function onCatalogReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_74.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_74.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_74.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_160)
         {
            Component(var_160).events.addEventListener(HabboConfigurationEvent.const_145,onConfigurationLoaded);
            if(var_203 != null)
            {
               var_203.configuration = var_160;
            }
            if(var_204 != null)
            {
               var_204.configuration = var_160;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_440.events.addEventListener(AdEvent.const_446,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1752)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1209);
            var_1752 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_558,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_615,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_194,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_143,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_153,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_193,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_666,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_42,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_392,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_409:
               var_1136.registerWarning(LagWarningLogger.const_953);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_758)
            {
               var_758.release(new IIDHabboWindowManager());
               var_758 = null;
            }
            if(var_440)
            {
               var_440.release(new IIDHabboAdManager());
               var_440 = null;
            }
            if(_navigator)
            {
            ...
            if(var_74)
            {
               if(true)
               {
                  var_74.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_74.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_74.release(new IIDHabboCatalog());
               var_74 = null;
            }
            if(var_8)
            {
            ...
            if(var_159)
            {
               if(true)
               {
                  Component(var_159).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_159).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_159).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_159).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_159).events.removeEventListener(HabboFriendListTrackingEvent.const_300,onFriendlistTrackingEvent);
               }
               var_159.release(new IIDHabboFriendList());
               var_159 = null;
            }
            if(var_368)
            {
               if(true)
               {
                  var_368.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_368.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_368.release(new IIDHabboHelp());
               var_368 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_409,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_145);
         if(var_160)
         {
            Component(var_160).events.removeEventListener(HabboConfigurationEvent.const_145,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_74);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_74,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_368 = param2 as IHabboHelp;
         var_368.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_368.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_803);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_803,onCoreRunning);
         }
      }
      ...
      {
         var_758 = IHabboWindowManager(param2);
         if(var_758)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_936 > -1 && _loc2_ < var_936)
         {
            ++var_1407;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1407);
         }
         if(var_936 > -1 && _loc2_ - var_936 > 15000)
         {
            ++var_1406;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1406);
         }
         var_936 = _loc2_;
         if(var_204 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_409,onLagWarningEvent);
      ...
      {
         var_159 = param2 as IHabboFriendList;
         Component(var_159).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_159).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_159).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_159).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_159).events.addEventListener(HabboFriendListTrackingEvent.const_300,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_1751)
         {
            var_1751 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1251,new Date().getTime().toString());
            if(var_160)
            {
               if(var_160.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_204 != null)
                  {
                     _loc4_["null"] = var_204.flashVersion;
                     _loc4_["null"] = var_204.averageUpdateInterval;
                  }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_74,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_666)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1292);
         }
         else if(param1.type == HabboHotelViewEvent.const_392)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1166);
         }
         else if(param1.type == HabboHotelViewEvent.const_42)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1215);
         }
      }
   }
}
