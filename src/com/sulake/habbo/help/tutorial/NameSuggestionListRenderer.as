package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      {
         var _loc2_:ITextWindow = var_44.buildXmlWindow("tutorial_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_755 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_755 += param1.height + const_1601;
            return fit(param1);
         }
         param1.offset(_offsetX,var_755);
