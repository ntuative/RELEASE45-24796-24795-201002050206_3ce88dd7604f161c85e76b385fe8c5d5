package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_26.tellUI(HabboHelpViewEnum.const_172,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_26.tellUI(HabboHelpViewEnum.const_242,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_26.tellUI(HabboHelpViewEnum.const_125);
      }
      ...
      {
         var_26.showUI(HabboHelpViewEnum.const_301);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_26.showUI(HabboHelpViewEnum.const_424);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_26.showUI(HabboHelpViewEnum.const_579);
         var_26.tellUI(HabboHelpViewEnum.const_579,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_332)
            {
         ...
         var_26.tellUI(HabboHelpViewEnum.const_519);
      }
