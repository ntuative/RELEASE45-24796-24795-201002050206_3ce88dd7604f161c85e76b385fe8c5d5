package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2036:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24796-24795-201002050139");
         var_192 = param5;
         var_96 = new Map();
         var_96.add(HabboHelpViewEnum.const_1221,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_125,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_424,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_242,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_172,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_579,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_301,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_509,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_188,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_96.add(HabboHelpViewEnum.const_868,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_519,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_253 == HabboHelpViewEnum.const_125 || false)
         {
            return;
         }
         if(var_396 == null)
      ...
      {
         return var_96.getValue(var_253);
      }
      ...
      {
         var_2035 = param1;
         var _loc2_:IHelpViewController = var_96.getValue(HabboHelpViewEnum.const_125) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_188:
               ...
               break;
            case CallForHelpResultEnum.const_962:
               showUI(HabboHelpViewEnum.const_868);
               break;
            case CallForHelpResultEnum.const_989:
      ...
      {
         var _loc3_:* = null;
         if(var_253 == HabboHelpViewEnum.const_125)
         {
            return;
         }
         if(true)
         {
            ...
            var_558.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_558[1],var_558[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_558[0],var_558[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1490;
         _window.width = _loc1_.width + var_1491;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_192 != null)
            {
               var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_26.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_683));
      }
