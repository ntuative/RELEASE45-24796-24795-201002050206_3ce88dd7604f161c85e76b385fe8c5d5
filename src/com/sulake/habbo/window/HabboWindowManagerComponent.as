package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_325:uint = 3;
      ...
      private var var_1187:ProfilerAgentTask;
      
      private var var_1184:IEventDispatcher;
      
      private var var_2340:uint = 0;
      
      private var var_1186:ProfilerAgentTask;
      
      private var var_1185:ProfilerOutput;
      
      private var var_646:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_180 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1184 = Component(param1).events;
            var_791 = new Array();
      ...
      {
         return var_276[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_276[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_646 = new WindowRenderer(_loc4_);
         var_276 = new Array(const_325);
         var _loc6_:int = 0;
         while(_loc6_ < const_325)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_646,this,_localization,var_180,new Rectangle(0,0,var_180.stageWidth,var_180.stageHeight),this);
            var_276[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_358 = var_276[const_1062];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_358.getMouseCursor().defineCustomCursorType(MouseCursorType.const_268,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_358.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1309,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_276[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_276.pop()).dispose();
            }
            if(_localization)
            {
      ...
      {
         return var_276[param1].getDesktopWindow().getChildAt(var_358.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1185 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1185 = new ProfilerOutput(_loc3_,this,var_646);
               var_1187 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1187);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_880.length > 0)
         {
            var_1184.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_325 - 1;
            while(_loc2_ >= 0)
            {
               var_276[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_964)
         ...
         var_1184.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_325)
         {
            var_276[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_964)
         {
         ...
         if(WindowContext.var_880.length > 0)
         {
            WindowContext.var_880.flush();
         }
         if(WindowContext.var_1319.length > 0)
         {
            WindowContext.var_1319.flush();
         }
         var_1184.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_791[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_791[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1121,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1341,param2.name + ": " + param2.toString());
            }
         }
      }
   }
