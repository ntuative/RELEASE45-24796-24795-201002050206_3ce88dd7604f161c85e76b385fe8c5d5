package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_652 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_652.procedure = onSearchInput;
         var_652.addEventListener(WindowKeyboardEvent.const_129,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_42.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_296,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = var_42.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_652.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(var_42.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
