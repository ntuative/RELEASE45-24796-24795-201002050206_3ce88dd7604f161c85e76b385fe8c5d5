package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         var _loc4_:Boolean = param1.id == FriendListTab.const_61 && !param1.newMessageArrived;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_300);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         var_17.width = _friendList.tabs.tabContentWidth;
         var_17.findChildByName("bg").width = _friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in _friendList.tabs.getTabs())
         {
            _loc4_ = var_17.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         var_17.height = _loc2_ + 1;
         var_17.findChildByName("bg").height = var_17.height;
