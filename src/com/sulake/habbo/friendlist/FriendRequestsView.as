package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_289 && _loc4_.state != FriendRequest.const_286)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_289;
      ...
      {
         var_1378 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1379 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1379.procedure = onDismissAllButtonClick;
         var_1378.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_286;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_124)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1378,_loc1_);
         setEnabled(var_1379,_loc1_);
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         var_42.removeListItem(param1.view);
         refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         var_42.addListItem(param1.view);
         _friendList.friendRequests.refreshShading();
         refreshButtons();
      }
