package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_781:int = 0;
      
      public static const const_405:int = -1;
      
      public static const const_293:int = 100;
      ...
      {
         return Math.ceil(this.var_208.length / const_293);
      }
      ...
      {
         if(this.var_765 >= this.getPageCount())
         {
            this.var_765 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_208[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_208.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_765 + 1) * const_293,this.var_208.length);
      }
