package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1433:int = "F".charCodeAt(0);
      
      public static const const_1584:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_605 = param1.online;
         var_1134 = param1.followingAllowed && param1.online;
         var_538 = param1.figure;
         var_1152 = param1.motto;
         var_1154 = param1.lastAccess;
