package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_137:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1664:IAvatarRenderManager;
      
      private var var_1358:AvatarSearchResults;
      
      private var var_111:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_741:FriendRequests;
      
      private var var_1667:int;
      
      var var_306:FriendCategories;
      
      private var var_192:IHabboToolbar;
      
      private var var_1665:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_352:FriendListTabs;
      
      private var var_1666:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1357:OpenedToWebPopup;
      ...
      {
         var_1665 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_306 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1358 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1357 == null)
         {
            var_1357 = new OpenedToWebPopup(this);
         }
         var_1357.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_741.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_741.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_352.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_741.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_192.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_111 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_306.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_741 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_306.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_306.addCategory(new FriendCategory(FriendCategory.const_781,getText("friendlist.friends")));
         var_306.addCategory(new FriendCategory(FriendCategory.const_405,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_306.addFriend(new Friend(_loc4_));
         }
         var_352 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_306.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_61);
      ...
      {
         var _loc2_:IAvatarImage = var_1664.createAvatarImage(param1,AvatarScaleType.const_80);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1664 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_741.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_352.findTab(FriendListTab.const_83);
      ...
      {
         var_1666 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_306.getFriendCount(param1,param2);
      }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_352.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_300));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_61:
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1358.searchReceived(_loc2_.friends,_loc2_.others);
