package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1620:IContainerButtonWindow;
      ...
      {
         var_1621 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1620 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1622 = initButton("room_invite",onInviteButtonClick,param1);
         var_1619 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_61,param4);
         _loc6_.visible = true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboFriendList.const_137) as IBitmapWrapperWindow;
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_335.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1621,isEnableMinimailButton(_loc1_));
         setEnabled(var_1620,isEnableHomeButton(_loc1_));
         setEnabled(var_1622,isEnableInviteButton(_loc1_));
         setEnabled(var_1619,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = var_42.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
         ...
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_61,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_61).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_61,param1);
      }
