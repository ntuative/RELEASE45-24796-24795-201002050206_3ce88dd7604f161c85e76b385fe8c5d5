package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1342:IMessageComposer;
      ...
      {
         var_828 = IWindowContainer(var_44.getXmlWindow("chatlog_roomheader"));
         var_827 = IWindowContainer(var_44.getXmlWindow("chatlog_chatline"));
         var_470 = new Timer(300,1);
         var_470.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_45 = IFrameWindow(var_44.getXmlWindow("chatlog_frame"));
         var_42 = IItemListWindow(var_45.findChildByName("chatline_list"));
         var_45.procedure = onWindow;
         var _loc1_:IWindow = var_45.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_44.connection.send(var_1342);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_828.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_45,var_44,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
         ...
         {
            populateChatline(var_42,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_827.clone());
         _loc4_.color = var_1250[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_45,var_44,_loc6_,param2.chatterId);
         }
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(var_42.getListItemAt(_loc1_));
