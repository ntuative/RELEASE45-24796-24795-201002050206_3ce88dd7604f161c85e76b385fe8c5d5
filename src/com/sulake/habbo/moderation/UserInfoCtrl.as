package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_44,WindowTracker.const_912,_data.userId),_callerFrame,var_1024,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_858.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_44.getXmlWindow("user_info"));
            var_858.addChild(_loc1_);
            var_44.disableButton(var_44.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_44.disableButton(var_44.initMsg.alertPermission,_loc1_,"message_but");
            var_44.disableButton(var_44.initMsg.alertPermission || var_44.initMsg.kickPermission || var_44.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new ModActionCtrl(var_44,_data.userId,_data.userName,var_1165),_callerFrame,var_1024,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new RoomVisitsCtrl(var_44,_data.userId),_callerFrame,var_1024,false,true);
      }
      ...
      {
         var_44.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_44.messageHandler.addUserInfoListener(this);
         var_44.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_44.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_44 = null;
         _data = null;
         var_858 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new SendMsgsCtrl(var_44,_data.userId,_data.userName,var_1165),_callerFrame,var_1024,false,true);
      }
