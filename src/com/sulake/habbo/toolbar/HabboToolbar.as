package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_532.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_29)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_927,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_142,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_149,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_30,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_421,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_710,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_841,onHideWindowEvent);
         var_29 = true;
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_29 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_30)
            {
