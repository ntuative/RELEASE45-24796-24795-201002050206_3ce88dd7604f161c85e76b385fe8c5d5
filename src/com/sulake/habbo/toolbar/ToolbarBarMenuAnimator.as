package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1072:Number = 90;
      ...
      private static const const_170:Boolean = true;
       
      
      private var var_568:Timer;
      
      private var var_1014:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1014 = param2;
         var_568 = new Timer(const_1074);
         var_568.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_475.push(param2);
         param1.addEventListener(WindowEvent.const_364,windowEventListener);
         param1.addEventListener(WindowEvent.const_207,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1014.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_288.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_288.splice(var_288.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1014.getIconLoc(param1.iconId);
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_288[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_755 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_755 || param1.desktop.height - param1.y < const_1093;
      }
