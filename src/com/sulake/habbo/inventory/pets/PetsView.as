package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_279:PetsGridItem;
      ...
      private var var_427:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_427 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_553 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_553.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_279 != null)
         {
            var_279.setSelected(false);
         }
         var_279 = param1;
         if(var_279 != null)
         {
            var_279.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_279.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_553.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_427.removeGridItem(_loc2_.window);
         if(var_279 == _loc2_)
         {
            var_279 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_553.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_427.addGridItem(_loc2_.window);
            var_553.add(param1.id,_loc2_);
            if(var_279 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImage(_loc12_.figure,AvatarScaleType.const_34);
            if(_loc13_ == null)
            {
               return;
            }
