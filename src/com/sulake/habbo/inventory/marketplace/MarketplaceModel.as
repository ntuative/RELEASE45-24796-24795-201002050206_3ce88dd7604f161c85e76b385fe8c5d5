package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_205 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_205.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_205 is FloorItem ? 1 : 2;
         var_1802 = _loc2_;
         var_1803 = var_205.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_205.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1425,var_1424);
         }
      }
      ...
      {
         if(param1 != var_1802 || param2 != var_1803)
         {
            return;
         }
         if(!_view)
      ...
      {
         if(_controller != null && false && var_205 != null)
         {
            _controller.furniModel.removeLockFrom(var_205.id);
            var_205 = null;
         }
      }
