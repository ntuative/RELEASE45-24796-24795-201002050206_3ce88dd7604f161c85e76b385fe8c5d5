package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1004:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_565 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_565.width;
         var_85 = var_565.height;
         var_1005 = param5;
         var_833 = param6;
         var_222 = Math.floor(var_1005 / _thumbWidth);
         var_15 = new BitmapData(var_1005,var_833);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         _loc2_ = new Rectangle((param1.x + 1) * _thumbWidth,param1.y * var_85,_loc4_ * _thumbWidth,var_85);
         _loc3_ = new Point(param1.x * _thumbWidth,param1.y * var_85);
         var _loc5_:BitmapData = new BitmapData(_loc2_.width + _thumbWidth,_loc2_.height);
         _loc5_.fillRect(_loc5_.rect,4294967295);
         _loc5_.copyPixels(var_15,_loc2_,new Point(0,0),null,null,true);
         var_15.copyPixels(_loc5_,_loc5_.rect,_loc3_,null,null,true);
         if(param1.y < var_472 - 1)
         {
            _loc7_ = 0 - _thumbWidth;
            _loc8_ = 0 - (param1.y + 1) * var_85;
            _loc9_ = new BitmapData(_loc7_,_loc8_);
            _loc2_ = new Rectangle(_thumbWidth,(param1.y + 1) * var_85,_loc9_.width,_loc9_.height);
            _loc9_.copyPixels(var_15,_loc2_,new Point(0,0),null,null,true);
            _loc10_ = new BitmapData(_thumbWidth,_loc2_.height);
            _loc2_.x = 0;
            _loc2_.width = _thumbWidth;
            _loc10_.copyPixels(var_15,_loc2_,new Point(0,0),null,null,true);
            var_15.fillRect(new Rectangle(0,0 - var_85,var_15.width,var_85),4294967295);
            _loc3_ = new Point(0 - _thumbWidth,_loc2_.y - var_85);
            var_15.copyPixels(_loc10_,_loc10_.rect,_loc3_,null,null,true);
            _loc3_ = new Point(0,_loc2_.y);
            var_15.copyPixels(_loc9_,_loc9_.rect,_loc3_,null,null,true);
         }
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_15.width,0 - var_85);
               _loc2_ = new Rectangle(0,0,var_15.width,0 - var_85);
               _loc11_.copyPixels(var_15,_loc2_,new Point(0,0),null,null,true);
               var_15 = _loc11_;
               --var_472;
            }
         }
         if(var_15.height < var_833)
         {
            _loc12_ = new BitmapData(var_15.width,var_833);
            _loc12_.fillRect(_loc12_.rect,4294967295);
            _loc12_.copyPixels(var_15,var_15.rect,new Point(0,0),null,null,true);
            var_15 = _loc12_;
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_565.width,var_565.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_565.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_565,var_565.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1004 != null)
         {
            _loc1_ = var_1004.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_472 = resolveRowCountFromList();
         if(var_472 == 0)
         {
            var_15 = new BitmapData(var_1005,var_833);
            return;
         }
         var_15 = new BitmapData(Math.max(var_222 * _thumbWidth,var_1005),Math.max(var_472 * var_85,var_833),true,16777215);
         var_15.fillRect(var_15.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_472)
         {
            _loc4_ = 0;
            while(_loc4_ < var_222)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_15.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_85),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_222 && var_15.height < _loc3_.y * var_85)
         {
            _loc2_ = new BitmapData(var_15.width,var_15.height + var_85);
         }
         else
         {
            _loc2_ = new BitmapData(var_15.width,var_15.height);
         }
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_222 - 1),var_85);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_222 - 1),0,_thumbWidth,var_15.height);
         _loc2_.copyPixels(var_15,_loc4_,new Point(0,var_85),null,null,true);
         _loc4_ = new Rectangle(0,var_85,_thumbWidth * (var_222 - 1),0 - var_85);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,var_85),null,null,true);
         var_15 = _loc2_;
      }
      ...
      {
         var _loc2_:int = Math.floor(param1.y / var_85);
      ...
      public function replaceItemImage(param1:int, param2:IThumbListDrawableItem) : void
      {
         ...
         var _loc4_:Point = new Point(_loc3_.x * _thumbWidth,_loc3_.y * var_85);
         var _loc5_:BitmapData = createThumbImage(param2.iconImage,param2.isSelected);
         var_15.copyPixels(_loc5_,_loc5_.rect,_loc4_,null,null,true);
      }
