package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_182,onObjectPlaced);
         var_455 = new Timer(const_1065,1);
         var_455.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_231;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_493)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_182,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_455 != null)
            {
               var_455.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_455.stop();
               var_455 = null;
            }
            if(var_121 != null)
            {
               var_121.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_121.stop();
               var_121 = null;
            }
            if(var_653 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_263)
         {
         ...
         else if(param3 == FurniCategory.const_281)
         {
         ...
         else if(param3 == FurniCategory.const_297)
         {
         ...
         if(var_653 == null)
         {
            var_653 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_653.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_231:
               ...
               break;
            case InventorySubCategory.const_985:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_121 = new Timer(param1,1);
            var_121.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_121.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_334);
      ...
      {
         if(var_800 && param1.type == RoomEngineObjectEvent.const_182)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_281 || _loc3_.category == FurniCategory.const_263 || _loc3_.category == FurniCategory.const_297)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_385 = new Map();
         var_385.add(const_24,new Array());
         var_385.add(const_25,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
