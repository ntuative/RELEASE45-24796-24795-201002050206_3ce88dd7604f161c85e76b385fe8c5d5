package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1617:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_40.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_40.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_69,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_81,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_333,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_40.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_81:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_333:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_40.getValue(InventoryCategory.const_553));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_40.getValue(InventoryCategory.const_54));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_972));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_40.getValue(InventoryCategory.const_154));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_40.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_40.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1617);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_40.getValue(InventoryCategory.const_275));
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_40.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_40.length)
         {
            _loc3_ = var_40.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_231:
      ...
      {
         return TradingModel(var_40.getValue(InventorySubCategory.const_231));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_509 = ISessionDataManager(param2);
      ...
      {
         return var_40.getValue(InventoryCategory.const_334) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_40.getValue(InventoryCategory.const_226));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_69,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_81,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_333,roomSessionEventHandler);
         ...
         var_40.add(InventoryCategory.const_334,_loc3_);
         ...
         var_40.add(InventoryCategory.const_54,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_509);
         var_40.add(InventoryCategory.const_226,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_40.add(InventoryCategory.const_553,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_509);
         var_40.add(InventoryCategory.const_275,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_40.add(InventorySubCategory.const_231,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_40.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_40.add(InventoryCategory.const_154,_loc10_);
