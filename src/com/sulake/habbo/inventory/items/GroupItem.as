package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2247:BitmapData;
      
      protected var var_891:Boolean;
      ...
      protected var var_348:BitmapData;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_493)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1549));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1320);
         }
         if(_loc1_.id > 0)
         {
