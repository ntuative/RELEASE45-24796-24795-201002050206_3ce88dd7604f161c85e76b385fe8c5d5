package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_754:uint = 4284532064;
      
      private static const const_753:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            var_335.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_384);
            var_335.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_54.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_54.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         return var_54.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:ITextWindow = var_54.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_54.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_54 == null)
         {
            var_54 = createNormalWindow();
         }
         if(var_1506 == null)
         {
            var_1506 = createMinimizedWindow();
         }
         if(!var_2085)
         {
            return var_54;
      ...
      {
         var _loc2_:ITextWindow = var_54.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc1_:ITextWindow = var_54.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_54.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc1_:ITextWindow = var_54.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_54.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_54.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_20.otherUserName;
            }
            _loc1_ = var_54.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_754) : uint(const_753);
            }
            _loc3_ = var_54.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_54.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_754) : uint(const_753);
            }
            _loc3_ = var_54.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_54.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_54)
         {
            _loc1_ = var_54.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
