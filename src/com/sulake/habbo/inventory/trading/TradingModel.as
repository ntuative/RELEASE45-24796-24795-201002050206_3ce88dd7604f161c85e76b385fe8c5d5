package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_150:uint = 1;
      
      public static const const_147:uint = 0;
      
      public static const const_1247:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_418 = false;
         var_597 = false;
         var_38.updateItemList(var_598);
         var_38.updateItemList(var_1069);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_38.alertPopup(TradingView.const_771);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_598)
            {
               var_418 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_597 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_38.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_598)
            {
               var_38.alertPopup(TradingView.const_956);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_29 + " NEW STATE: " + param1 + " OWN: " + var_418 + " OTHER: " + var_597);
         ...
         {
            case const_147:
               if(param1 == const_150 || param1 == const_195)
               {
                  var_29 = param1;
                  _loc2_ = true;
               }
            ...
            case TRADING_STATE_CANCELLED:
               ...
               break;
            default:
               throw new Error("Unknown trading progress state: \"" + var_29 + "\"");
         }
         if(_loc2_)
         {
            var_38.updateUserInterface();
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = var_197.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function close() : void
      {
         if(var_520)
         {
            if(var_29 != const_147 && var_29 != const_195)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_147;
            var_8.toggleInventorySubPage(InventorySubCategory.const_985);
            var_520 = false;
         }
         var_38.setMinimized(false);
      }
