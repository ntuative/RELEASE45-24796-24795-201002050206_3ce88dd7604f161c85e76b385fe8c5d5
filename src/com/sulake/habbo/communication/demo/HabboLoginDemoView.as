package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_327.shockwaveClientUrl = var_106.shockwaveClientUrl;
         var_327.ssoTicket = var_106.ticket;
         var_106.removeEventListener(SSOTicket.const_298,onParsedTicketSuccess);
         var_106.removeEventListener(SSOTicket.const_244,onParsedTicketFailure);
         var_106 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_327.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_385,HabboWindowStyle.const_23,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_82,windowEventProcessor);
         }
         else
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_106 = new SSOTicket(var_327.assets,_loc2_,_loc1_);
         var_106.addEventListener(SSOTicket.const_298,onParsedTicketSuccess);
         var_106.addEventListener(SSOTicket.const_244,onParsedTicketFailure);
      }
