package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_155:HabboHotelView;
      ...
      private var var_1709:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1380:ILogger;
      ...
      private var var_430:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_923)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_153);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_302:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_778:
            ...
            case DisconnectReasonEvent.const_846:
               ...
               break;
            case DisconnectReasonEvent.const_880:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1710)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_616 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_616);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_143);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1118,var_1708));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_430.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_430.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1709);
      ...
      {
         var_616 = _habboConfiguration.getKey("sso.ticket",null);
         var_1118 = _habboConfiguration.getKey("flash.client.url","");
         var_1708 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_155 == null)
         {
            var_155 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_616 != null)
         {
            var_60.mode = HabboConnectionType.const_371;
            var_60.initConnection(HabboConnectionType.const_237);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1380 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_615);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1709 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_60.mode)
         {
            case HabboConnectionType.const_371:
               _loc6_ = "";
               ...
               var_924 = _loc4_;
               var_155.loadBannerImage(_loc7_ + "?token=" + var_924,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1216:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1359:
               var_925 = generateRandomHexString(30);
               var_430 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_430.init(var_925);
               _loc8_ = var_430.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_155.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_924);
         ...
         var_430 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_925 = generateRandomHexString(30);
            var_430.init(var_925);
            _loc12_ = var_430.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_145,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_81,onRoomSessionEnded);
      }
