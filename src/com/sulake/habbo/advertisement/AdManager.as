package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1889:BitmapData = null;
      ...
      private var var_1888:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_446,0,0,_loc4_,var_1433,var_1888,var_1889));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1887 = int(_config.getKey("interstitial.interval","30000"));
         var_1886 = int(_config.getKey("interstitial.show.time","5000"));
         var_1434 = int(_config.getKey("interstitial.max.displays.flash","-1"));
         ...
         if(_loc3_ != "" && _loc4_ != "")
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_15,adWarningLeftReady);
            _loc6_ = new URLRequest(_loc4_);
            _loc7_ = _assets.loadAssetFromFile("adWarningRight",_loc6_,"image/png");
            _loc7_.addEventListener(AssetLoaderEvent.const_15,adWarningRightReady);
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1176 = _loc2_.imageUrl;
         var_1433 = _loc2_.clickUrl;
         if(var_1176 != "" && var_1433 != "")
         {
            _loc3_ = var_1176;
            ...
            _loc4_ = new URLRequest(var_1176);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_15,roomAdImageReady);
         }
      }
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1177 = _loc2_.imageUrl;
         var_1885 = _loc2_.clickUrl;
         var_643 = getTimer();
         if(var_1177 != "")
         {
            _loc3_ = var_1177;
            ...
            var_213.start();
            _loc4_ = new URLRequest(var_1177);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_15,interstitialLoaderEventHandler);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_390,0,0,param1.bitmapData,var_1885));
            var_643 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1889 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1434 > 0 && var_1435 >= var_1434)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_643;
         if(_loc1_ > var_1887)
         {
            ++var_1435;
      ...
      {
         var_532 = param2 as IHabboCommunicationManager;
         if(var_532 == null)
         {
            return;
         }
         _connection = var_532.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_399));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1888 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
