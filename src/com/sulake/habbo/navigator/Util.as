package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1365:CutToHeight = new CutToHeight();
      
      private static var var_1364:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1365.beforeSearch(param2,param1,param3);
         binarySearch(var_1365,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1364.beforeSearch(param2,param1,param3);
         binarySearch(var_1364,param2.length - 1);
      }
   }
}
