package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_720:int = 32;
      
      private static const const_1009:int = 8;
      ...
      private var var_719:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_719 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_719.getImage(ThumbnailEditorModel.const_16,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1008,_loc4_.y + const_1010 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1574[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_719.getImage(ThumbnailEditorModel.const_19,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_719.getImage(ThumbnailEditorModel.const_19,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_719.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_720 / 2);
         return new Point(param1 * const_720 + _loc3_,param2 * const_1009);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_331)
         {
            if(false)
            {
               refreshObj(param1,var_895[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1070 == null)
         {
            var_1070 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1070,var_1070.rect,new Point(0,0),null,null,true);
      }
   }
}
