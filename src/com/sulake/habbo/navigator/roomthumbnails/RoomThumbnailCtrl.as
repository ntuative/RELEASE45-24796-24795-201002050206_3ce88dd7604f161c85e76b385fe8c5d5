package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this._model.mode != ThumbnailEditorModel.const_19);
         setEnabled(var_1339,this._model.mode != ThumbnailEditorModel.const_35);
         setEnabled(var_1340,this._model.mode != ThumbnailEditorModel.const_16);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_19;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1339 = IButtonWindow(find("top_tab"));
         var_1340 = IButtonWindow(find("obj_tab"));
         var_1572 = IWindowContainer(find("tile_grid"));
         var_1571 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1339,onTopTabButton);
         Util.setProcDirectly(var_1340,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1572;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1571;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_39,HabboWindowStyle.const_20,HabboWindowParam.const_49,new Rectangle(0,0,param1.width,66)));
      ...
      {
         refreshImgSelector(ThumbnailEditorModel.const_19);
