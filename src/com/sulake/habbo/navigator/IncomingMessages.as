package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboNavigator)
      {
         ...
         _loc2_.addHabboConnectionMessageEvent(new FlatControllerRemovedEvent(method_8));
      ...
      private function onFavouriteChanged(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Received favourite changed: " + _loc2_.flatId + ", " + _loc2_.method_7);
         _navigator.data.favouriteChanged(_loc2_.flatId,_loc2_.method_7);
      ...
      private function method_8(param1:IMessageEvent) : void
      {
         ...
         for each(_loc3_ in _navigator.roomSettingsCtrls)
         {
            _loc3_.method_8(_loc2_.flatId,_loc2_.userId);
         }
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.EXITROOM);
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_142,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_146)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_101)
            {
