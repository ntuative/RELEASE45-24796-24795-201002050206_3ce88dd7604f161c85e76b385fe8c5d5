   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            _loc5_ = _container.avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_34);
            if(_loc5_ != null)
            {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_581,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_457,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_85,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_581,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_138,onCreditBalance);
         }
         var_8 = _container.inventory;
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_972,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_675,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_457,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_85,onHelpTutorialEvent);
         }
         var_74 = _container.catalog;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_85:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_85));
               break;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_508);
         _loc1_.push(RoomWidgetDanceMessage.const_677);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_646);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_485);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_680);
         _loc1_.push(RoomWidgetStopEffectMessage.const_503);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1175);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_940);
         _loc1_.push(RoomWidgetToolbarMessage.const_559);
         ...
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_975);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_584);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_695);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_704);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_590);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1204);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_603);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_701);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_689);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_601));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_508:
               ...
               break;
            case RoomWidgetDanceMessage.const_677:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_646:
               if(var_8 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_562:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_680:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_74 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.CATALOG_CLUB)
               {
                  var_74.openCatalogPage(CatalogPageName.const_291,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_485:
               ...
               if(var_8 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_780:
                        var_74.openCatalogPage(CatalogPageName.const_1119,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_928:
                        var_8.toggleInventoryPage(InventoryCategory.const_226);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1268:
                        var_8.toggleInventoryPage(InventoryCategory.const_54);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1319:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_503:
            ...
            case RoomWidgetNavigateToRoomMessage.const_940:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_584:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_559:
               ...
               if(var_192)
               {
                  var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                  ...
                  if(var_74 != null && var_74.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_74.getPurse().credits));
                  }
               }
            ...
            case RoomWidgetToolbarMessage.const_521:
               ...
               if(var_192 && false)
               {
                  var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_421,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_629:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_393,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_980));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_393,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1369));
                     }
                  }
               ...
               break;
            case RoomWidgetRedeemClubPromoMessage.const_704:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_590:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_318,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_603:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_318,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_701:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_318,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_689:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_536));
               }
               break;
            default:
