package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1616:String = "room_widget";
      
      private const const_1630:String = "room_desktop_layout_container";
      
      private const const_1094:String = "room_view";
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_55.getChildByTag(const_1094) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_55.findChildByTag(const_1094) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_691;
               _loc2_.width = var_55.desktop.width - var_691;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_691;
               _loc2_.height = var_55.desktop.height - var_691;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_55.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1616) == 0)
            {
