package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_403:PartSetsData;
      
      private var var_2070:PartOffsetData;
      
      private var var_832:AvatarActionManager;
      
      private var var_143:IAssetLibrary;
      
      private var var_2290:IAssetLibrary;
      
      private var var_1329:Boolean = false;
      
      private var var_2069:AvatarRenderManager;
      
      private var var_471:FigureData;
      ...
      private var var_1500:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_143 = param2;
         var_2290 = param3;
         var_471 = new FigureData();
         var_403 = new PartSetsData();
         _animationData = new AnimationData();
         var_1500 = new AvatarStructureDownloadSet();
         var_673 = new AnimationManager();
         var_674 = param4;
         var_2070 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_832.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_674)
         {
            case AvatarType.const_71:
               _loc1_ = var_143.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_403.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_143.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_143.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_471.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_143.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_403.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_143.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_143.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_471.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_832.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_832.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_403.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_403.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1368[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_832.getDefaultActionType();
         var _loc7_:Array = var_403.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_673.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_471.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_471.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_403.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_403.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_71:
               if(var_143.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_143.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_143.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_143.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_403.getPartDefinition("ri").appendToFigure = true;
            var_403.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_71:
               var_1500.add(new AvatarStructureDownload(var_143,_loc5_,var_471));
               break;
            case AvatarType.PET:
         }
         var_1500.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_832 = new AvatarActionManager(var_143,var_674);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_143.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_143.getAssetByName("dance" + _loc1_).content as XML;
            var_673.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_143.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_143.getAssetByName("fx" + _loc1_).content as XML;
            var_673.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_2070.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_471.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_471.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_832.sortActions(param1);
      }
   }
}
