package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1348 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_80);
         var_1348.setDirection(AvatarSetType.const_21,int(FigureData.const_800));
         _image = var_1348.getImage(AvatarSetType.const_21);
         _view.udpate(_image);
      }
