package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_403:String = "fx";
      ...
      private var var_1484:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_1229 = parseInt(param2.@dz);
         var_1145 = parseInt(param2.@dd);
         _type = param3;
         var_990 = String(param2.@base);
         var _loc6_:String = "";
         if(var_990 != "")
         {
         ...
         if(param5 != null)
         {
            var_1484 = new ActiveActionData(param5.state,_loc6_);
            var_1484.definition = param5;
         }
      }
      ...
      public function baseAsInt() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_990.length)
         {
            _loc1_ += var_990.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
