package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_658["null"] = new AvatarEditorGridView(param1,FigureData.const_123,param2,param3);
         var_658["null"] = new AvatarEditorGridView(param1,FigureData.const_148,param2,param3);
         var_658["null"] = new AvatarEditorGridView(param1,FigureData.const_136,param2,param3);
         attachImages();
