package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_669 > -1)
         {
            return var_332[var_669] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_669 >= 0)
         {
            _loc3_ = var_332[var_669];
            _loc3_.isSelected = false;
         }
         if(var_332.length > param1)
         {
            _loc2_ = var_332[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_669 = param1;
