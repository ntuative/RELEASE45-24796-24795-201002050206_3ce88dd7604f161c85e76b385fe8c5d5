package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1043:String = AvatarSetType.const_21;
      
      private static const const_1042:String = "Default";
      
      private static const const_1041:int = 125;
      ...
      private var var_438:IAvatarDataContainer;
      ...
      private var var_161:IActiveActionData;
      
      private var var_61:AvatarStructure;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_177 == null)
         {
            var_177 = AvatarScaleType.const_34;
         }
         ...
         var_127 = new AvatarImageCache(var_61,this,_assets,var_177);
         setDirection(const_1043,const_1040);
         var_178 = new Array();
         resetActions();
      }
      ...
      private function solvePetAvatarTypeAndRace(param1:int) : void
      {
         ...
         var_939 = 0;
         var_1144 = 0;
         var _loc2_:ISetType = var_61.figureData.getSetType("pbd");
         if(_loc2_ != null)
         {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1145;
         if(param2 < AvatarDirectionAngle.const_1214)
         {
            param2 = AvatarDirectionAngle.const_599 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_599)
         {
            param2 -= NaN;
         }
         if(var_674 == AvatarType.PET && param1 == AvatarSetType.const_28)
         {
            if((var_84 == 6 || var_84 == 0) && param2 == 7)
            {
               param2 = var_84;
            }
            _loc3_ = var_61.renderManager.petDataManager.getPetData(_avatarSubType);
            if(_loc3_ != null)
            {
         ...
         if(var_61.isMainAvatarSet(param1))
         {
            var_84 = param2;
         }
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_61.sortActions(var_178);
         if(_loc1_ == null)
         {
         ...
         {
            var_537 = var_61.getCanvasOffsets(_loc1_,var_177,var_84);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            {
               _isAnimating = true;
               _loc3_ = var_61.getAnimation(_loc2_.definition.state + "." + _loc2_.actionParameter);
               if(_loc3_ != null)
               {
                  var_165 = var_165.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1145 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_438 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_679)
            {
               _isAnimating = true;
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_370)
            {
               _isAnimating = true;
            }
         }
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_178.length)
         {
            _loc3_ = var_178[_loc4_];
         ...
         var_178.push(new ActiveActionData(param1,param2));
      }
      
      public function getPartColor(param1:String) : IPartColor
      {
         return var_61.getPartColor(var_538,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_61.getCanvas(var_177,var_161.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_61.getBodyParts(param1,var_161.definition,var_84);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_439);
            if(_loc10_ != null)
            {
               ...
               if(var_674 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_61.getParts(_loc9_,var_538,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_177 == AvatarScaleType.const_80)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_439);
                     _loc21_ = var_84;
                     _loc22_ = 1;
                     switch(var_84)
                     {
                     ...
                     _loc23_ = var_61.getPartActionOffset(getSubType(),var_177,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_61.getCanvas(var_177,var_161.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_61.getBodyParts(param1,var_161.definition,var_84);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_439);
            if(_loc8_ != null)
            {
               ...
               if(var_674 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_61.getParts(_loc7_,var_538,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_439);
                     _loc19_ = var_84;
                     _loc20_ = 1;
                     switch(var_84)
                     {
                     ...
                     _loc21_ = var_61.getPartActionOffset(getSubType(),var_177,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_438 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_438.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_438 = null;
         var_1145 = 0;
         var_61.removeDynamicItems();
         var_161 = new ActiveActionData(AvatarAction.const_829);
         var_161.definition = var_61.getActionDefinition(const_1042);
         setActionToParts(var_161);
         getCache().resetBodyPartCache(var_161);
         return true;
      }
      
      public function updateAnimation(param1:Number) : void
      {
         var_439 = int(param1 % const_1041);
         var_272 = true;
      }
      ...
      {
         return var_61.getBodyPartData(param1.animation.id,var_439,param1.id);
      }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         switch(param1)
         {
            case AvatarAction.const_628:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1286:
                     if(var_674 == AvatarType.const_71)
                     {
                        if(var_84 == 0)
                        {
            ...
            case AvatarAction.const_929:
               _loc4_ = var_61.getActionDefinitionWithState(param1);
               if(_loc4_ != null)
               {
