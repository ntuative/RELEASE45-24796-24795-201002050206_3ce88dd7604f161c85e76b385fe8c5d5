package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel implements IAvatarEditorCategoryModel
   {
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         ...
         _controller.figureData.savePartData(FigureData.const_37,_loc4_.id,_loc3_.currentColourId,true);
      }
      ...
      private function init() : void
      {
         ...
         var_306["null"] = _controller.generateDataContent(this,FigureData.const_37);
         updateCategoryData(FigureData.const_37);
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc2_:int = _controller.figureData.getPartSetId(FigureData.const_37);
         var _loc3_:int = _controller.figureData.getColourId(FigureData.const_37);
      ...
      public function toggleColourSelection(param1:String, param2:int) : void
      {
         ...
         _controller.figureData.savePartSetColourId(FigureData.const_37,_loc3_.currentColourId,true);
         updateView();
      }
   }
}
