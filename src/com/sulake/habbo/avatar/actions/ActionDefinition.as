package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_29 = String(param1.@state);
         var_1693 = parseInt(param1.@precedence);
         var_1687 = String(param1.@activepartset);
         var_1686 = String(param1.@assetpartdefinition);
         var_1689 = String(param1.@lay);
         var_1280 = String(param1.@geometrytype);
         var_1691 = Boolean(parseInt(param1.@main));
         var_1688 = Boolean(parseInt(param1.@name_2));
         var_1690 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1112 = _loc2_.split(",");
         }
      ...
      {
         return var_1112.concat(getTypePrevents(param1));
      }
