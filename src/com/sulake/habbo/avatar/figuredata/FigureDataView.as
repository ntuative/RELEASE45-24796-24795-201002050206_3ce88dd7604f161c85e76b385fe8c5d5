package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_479:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1262 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_479 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_479.bitmap = new BitmapData(var_479.width,var_479.height,true,16777215);
         var_479.bitmap.copyPixels(var_1262,var_1262.rect,new Point(0,0 - 0 - 8));
         var_479.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
