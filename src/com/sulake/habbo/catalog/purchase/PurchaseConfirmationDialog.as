package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1603:uint = 4.291613146E9;
      ...
      private const const_1604:int = 10;
      ...
      public function receiverNotFound() : void
      {
         ...
         var_74.windowManager.alert("${catalog.gift_wrapping.receiver_not_found.title}","${catalog.gift_wrapping.receiver_not_found.info}",0,alertHandler);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         return var_74.windowManager.buildFromXML(_loc2_.content as XML);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_207.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      {
         if(this.var_69 == null || this.var_69.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_74.getProductData(var_69.localizationId);
         var _loc2_:String = _loc1_ == null ? "" : _loc1_.name;
         var_74.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","offer_name",_loc2_);
         var _loc3_:String = "";
         var _loc4_:String = "";
         var _loc7_:String = var_74.getPurse().credits.toString();
         var _loc8_:String = var_74.getPurse().pixels.toString();
         switch(var_69.priceType)
         {
            case Offer.const_336:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits";
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_69.priceInCredits.toString());
               _loc3_ = _loc5_.value;
            ...
            case Offer.const_358:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_69.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_69.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
         ...
         var_74.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","price",_loc3_);
         var_74.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.amount","amount",_loc4_);
      }
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_69.page.viewer.roomEngine;
      ...
      private function initColorGrid() : void
      {
         ...
         {
            _loc4_ = var_74.getFurnitureData(_loc6_,ProductTypeEnum.const_59);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_74.purchaseProduct(var_639,var_69,var_938);
               dispose();
               break;
            case "cancel_button":
      ...
      {
         if(var_207 == null || true)
         {
            return;
         }
         var _loc1_:IItemListWindow = var_207.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_245) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_535[var_176]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_534[var_175]);
         var_74.purchaseProductAsGift(var_639,var_69,var_938,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_121:
               ...
               if(var_1773 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_208)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1604)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1773 = _loc3_.text;
               break;
            case WindowMouseEvent.const_33:
               showSuggestions(false);
               if(var_1142)
               ...
               break;
            case WindowKeyboardEvent.const_684:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_245 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_245 + 1);
                     break;
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_74.getProductData(var_69.localizationId);
            _loc1_.text = _loc3_ == null ? "" : _loc3_.name;
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByName("product_image") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc4_ = var_69.page.viewer.roomEngine;
            _loc6_ = var_69.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_196:
                  _loc7_ = var_74.getPixelEffectIcon(_loc6_.productClassId);
                  break;
               case ProductTypeEnum.const_365:
                  _loc7_ = var_74.getSubscriptionProductIcon(_loc6_.productClassId);
            }
            if(_loc5_ != null)
            {
               _loc7_ = _loc5_.data;
      ...
      private function showGiftDialog() : void
      {
         ...
         var _loc1_:GiftWrappingConfiguration = var_74.giftWrappingConfiguration;
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_535 = _loc1_.boxTypes;
            var_534 = _loc1_.ribbonTypes;
            var_764 = var_1413[0];
            var_176 = var_535[0];
            var_175 = var_534[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_207.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_245) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_245);
         }
         var_245 = param1;
         if(var_245 < 0)
         {
            var_245 = _loc2_.numListItems - 1;
         }
         if(var_245 >= _loc2_.numListItems)
         {
            var_245 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_245) as IWindowContainer;
      ...
      private function setBitmapData(param1:IWindowContainer, param2:String, param3:String, param4:ColorTransform = null) : void
      {
         ...
         var _loc6_:BitmapDataAsset = var_74.assets.getAssetByName(param3) as BitmapDataAsset;
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_207 == null)
         {
            var_207 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_437 == null)
         {
            var_437 = createWindow("suggestion_list_item") as IWindowContainer;
            var_437.procedure = suggestionsEventHandler;
         }
         if(var_207 == null || var_437 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_207.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_437.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
