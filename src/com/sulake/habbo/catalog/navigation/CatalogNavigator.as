package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2330:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_242 = [];
         var_42 = _container.findChildByName("navigationList") as IItemListWindow;
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_74.configuration.getKey("client.credits.embed.enabled","false") == "com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_74.configuration.getKey("link.format.credits","/credits");
            var_74.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_74.openCatalogPage(var_2313,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_242.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_242)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_242.indexOf(_loc6_);
            var_242.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(var_242.indexOf(param1) == -1)
         {
            var_242.push(param1);
         }
         var_74.loadCatalogPage(param1.pageId);
         var_74.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_42);
            }
         }
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_74.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_74.loadCatalogPage(_loc2_.pageId);
         }
