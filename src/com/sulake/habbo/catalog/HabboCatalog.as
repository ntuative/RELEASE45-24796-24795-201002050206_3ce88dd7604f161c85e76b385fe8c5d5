package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_98:IMarketPlace;
      ...
      private var var_2231:GiftWrappingConfiguration;
      ...
      {
         return var_509.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2230 && var_771 != null)
         {
            var_771.playSound(HabboSoundTypesEnum.const_902);
         }
         var_2230 = false;
      }
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_59)
         {
            _loc3_ = var_509.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_60)
         {
            _loc3_ = var_509.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer" == var_160.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2231 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_30,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_185,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1047.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function createClubGiftController() : void
      {
         if(var_1047 == null)
         {
            var_1047 = new ClubGiftController(this);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_98.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_193 == null)
            {
               var_193 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_193.showOffer(this,param1,param2,param3,_loc7_);
      ...
      private function createMarketPlace() : void
      {
         if(var_98 == null)
         {
            var_98 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(method_9));
      ...
      {
         if(param1 == null || var_296 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_296.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_296.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2229 && var_771 != null)
         {
            var_771.playSound(HabboSoundTypesEnum.const_812);
         }
         var_2229 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_296.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_296.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_296 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_296.habboCatalog = this;
      }
