package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1219:IProductData;
      ...
      {
         super();
         var_1221 = param1.productType;
         var_1220 = param1.furniClassId;
         var_982 = param1.extraParam;
         var_981 = param1.productCount;
         var_1218 = param1.expiration;
         var_1219 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_60:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_982);
               break;
