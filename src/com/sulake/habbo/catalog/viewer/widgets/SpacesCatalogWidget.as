package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1258:String = "default";
      
      private var var_1232:Array;
      
      private var var_992:BitmapData = null;
      
      private var var_220:int = 0;
      
      private var var_665:int = 0;
      
      private var var_1257:String = "1.1";
      ...
      private var var_991:BitmapData = null;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_992 != null && var_991 != null)
         {
            setRoomImage(var_992,var_991);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_169:
               ...
               if(var_282 == _activeWallpaperPatterns.length)
               {
                  var_282 = 0;
               }
               var_220 = 0;
               ...
               for each(_loc8_ in var_160.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_666 = _loc8_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_floor_pattern_prev":
               changePattern(const_167,-1);
               break;
            case "ctlg_floor_pattern_next":
               changePattern(const_167,1);
               break;
            case "ctlg_floor_color_prev":
               changeColor(const_167,-1);
               break;
            case "ctlg_floor_color_next":
               changeColor(const_167,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = var_1232[var_280];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1234[var_281];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1257);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1258,var_1257,64,this,"window_romantic_wide");
