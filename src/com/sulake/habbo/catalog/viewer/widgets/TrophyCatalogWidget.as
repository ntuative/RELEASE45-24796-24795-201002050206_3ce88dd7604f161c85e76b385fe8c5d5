package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_364.getWithIndex(var_174);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_433);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_364.getValue(_loc6_) == null)
            {
               var_364.add(_loc6_,new Map());
            }
            _loc8_ = var_364.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_364.getWithIndex(var_174);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_433);
            if(_loc3_ == null)
            {
