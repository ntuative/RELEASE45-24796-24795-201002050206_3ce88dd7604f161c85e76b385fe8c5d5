package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1172:MarketPlaceOfferData;
      
      private const const_1397:int = 1;
      
      private const const_1605:int = 40;
      
      private var var_447:IWindowContainer;
      
      private const const_1396:int = 2;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1396,_loc2_.length);
         if(!var_379)
         {
            var_379 = new Timer(25);
            var_379.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_784 = 0;
         populateList();
         var_379.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_541)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1397);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_378.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_379)
         {
            var_379.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_379 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_784 >= var_541.length)
            {
               return true;
            }
            addListItem(var_541.getWithIndex(var_784));
            ++var_784;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1172.offerId);
                  hideDetails();
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_378));
            _loc7_.selection = 0;
         }
      }
