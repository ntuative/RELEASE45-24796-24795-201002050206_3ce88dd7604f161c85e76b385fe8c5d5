package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1094.text = "${" + _loc3_.name + "}";
            var_1093.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1094.text = "${" + _loc2_.localizationId + "}";
            var_1093.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_430:
                  _loc4_ = var_1231.clone();
                  if(var_557 != null)
                  {
                     var_557.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_557,var_1230,var_1325);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_196:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_34);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_28,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_280,AvatarAction.const_506);
                              _loc13_.appendAction(AvatarAction.const_626,_loc6_.productClassId);
      ...
      {
         var_1094 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1093 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_78 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1487 = new Point(var_78.x,var_78.y);
         var_557 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1230 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_557 == null)
         {
         ...
         var_1231 = _loc2_.content as BitmapData;
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_15,onPreviewImageReady);
      }
