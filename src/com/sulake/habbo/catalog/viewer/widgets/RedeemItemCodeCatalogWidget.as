package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_980 != null)
         {
            var_980.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_979 != null)
         {
            var_979.removeEventListener(WindowKeyboardEvent.const_129,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_980 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_980 != null)
         {
            var_980.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_979 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_979 != null)
         {
            var_979.addEventListener(WindowKeyboardEvent.const_129,windowKeyEventProcessor);
         }
      }
