package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_29:String = "RSE_CREATED";
      
      private var var_1038:UserDataManager;
      ...
      {
         if(var_29 == RoomSessionEvent.const_283 && _connection != null)
         {
            var_29 = RoomSessionEvent.const_69;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1038 as IUserDataManager;
      }
