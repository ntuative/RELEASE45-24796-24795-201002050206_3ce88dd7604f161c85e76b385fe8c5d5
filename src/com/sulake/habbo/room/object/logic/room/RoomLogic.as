package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1238:uint = 16777215;
      
      private var var_993:uint = 16777215;
      
      protected var var_71:RoomPlaneParser = null;
      
      private var var_816:int = 0;
      
      private var var_1211:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_606:
                  _loc2_.setString(RoomObjectVariableEnum.const_649,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_569:
                  _loc2_.setString(RoomObjectVariableEnum.const_574,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_490:
                  _loc2_.setString(RoomObjectVariableEnum.const_602,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_391:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_191)
                  {
                     _loc8_ = "null";
                  }
                  var_393.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_635:
                  _loc7_ = var_393.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_393.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_904,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_922,int(_loc5_.bgOnly));
            var_1238 = _color;
            var_1494 = var_1211;
            var_993 = _loc11_;
            var_1493 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_977,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_611,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_71.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_67,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1229,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1157,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1373,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_67,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_128)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_115 || _loc13_ == RoomPlaneData.const_219)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_816)
         {
            ...
            {
               _loc7_ = var_1238 >> 16 & 255;
               _loc8_ = var_1238 >> 8 & 255;
               _loc9_ = var_1238 & 255;
               _loc10_ = var_993 >> 16 & 255;
               _loc11_ = var_993 >> 8 & 255;
               _loc12_ = var_993 & 255;
               _loc13_ = (_loc2_ - var_816) / var_1492;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1494 + (var_1493 - var_1494) * _loc13_;
               _color = _loc3_;
               var_1211 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_611,_loc3_);
         }
      }
   }
}
