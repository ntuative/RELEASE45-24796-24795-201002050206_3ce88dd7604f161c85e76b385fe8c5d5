package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_740:int = 15;
      
      private static const const_1080:int = 2;
      
      private static const const_323:int = 2;
      
      private static const const_739:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_989[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_986[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_989 = new Array();
         var_989.push(Math.random() * _loc2_ * 1.5);
         var_989.push(Math.random() * _loc2_ * 1.5);
         var_988 = new Array();
         var_988.push(1);
         var_988.push(-1);
         var_987 = new Array();
         var_987.push(const_1080);
         var_987.push(const_1079);
         var_986 = new Array();
         var_986.push(getRandomAmplitudeFactor());
         var_986.push(getRandomAmplitudeFactor());
      }
