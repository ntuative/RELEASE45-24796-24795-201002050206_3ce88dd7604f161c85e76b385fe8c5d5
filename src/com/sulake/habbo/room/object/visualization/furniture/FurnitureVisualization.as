package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1384:Number = Math.sqrt(0.5);
      ...
      protected var var_1391:String = null;
      ...
      protected var var_2236:Number = NaN;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1391 != null && var_1391.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2251,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2163 != param1 || var_2162 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2164 != param1 || var_2165 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2251 = _loc3_.getNumber(RoomObjectVariableEnum.const_184);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_178));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1391 = _loc3_.getString(RoomObjectVariableEnum.const_314);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_268 != _loc3_.getUpdateID() || param1 != var_196 || param2 != var_2236)
         {
