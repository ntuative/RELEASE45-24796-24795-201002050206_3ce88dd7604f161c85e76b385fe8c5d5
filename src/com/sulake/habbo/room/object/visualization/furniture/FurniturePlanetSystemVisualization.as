package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_824);
      ...
      {
         if(param1 < var_539.length)
         {
            return var_539[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_210 != null)
         {
            ...
            {
               _loc2_ = var_210[_loc3_];
               _loc2_.update(var_539,var_1819,param1);
               _loc3_++;
            }
