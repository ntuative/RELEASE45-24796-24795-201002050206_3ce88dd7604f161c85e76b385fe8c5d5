package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1154:int = const_292;
      ...
      public static const const_221:int = const_78;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1442 == const_78)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_453);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_453,var_23.width,var_453);
         }
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_729,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_453,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
