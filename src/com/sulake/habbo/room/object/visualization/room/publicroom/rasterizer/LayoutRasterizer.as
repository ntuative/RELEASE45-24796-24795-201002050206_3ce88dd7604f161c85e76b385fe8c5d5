package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_2224:Vector3d;
      
      private var var_53:Map = null;
      ...
      {
         var_497 = true;
         var _loc3_:int = var_340.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_340.push(param1);
            var_496.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1043 = param1;
         var _loc3_:LayoutRasterizerData = var_53.getValue(var_706);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1314 = RoomObjectVariableEnum.const_849;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1314 = RoomObjectVariableEnum.const_792;
                           }
                           if(param2 != null)
                           {
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2224);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         if(var_53 != null)
         {
            ...
            {
               _loc2_ = var_53.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_706)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1044 = var_53.getValue(var_706);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_53.getValue(var_706);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1045.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1045.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_340.indexOf(_loc10_) >= 0 && var_497)
            {
               param1 = var_340.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_496[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_498[param1];
               }
               var_340.splice(param1,1);
