package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1402:int = 0;
      
      private var var_538:String;
      
      private var var_594:int = 0;
      
      private const const_1609:int = 1;
      ...
      private const const_1608:int = 2;
      
      private var var_802:AvatarVisualizationData = null;
      
      private const const_1067:int = 3;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_387.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_151);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_717);
         ...
         var _loc14_:Number = _loc8_ - var_1206;
         if(_loc14_ > 5000 && _loc6_ != null && _loc6_.getScale() == AvatarScaleType.const_34)
         {
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_284);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_268 != _loc3_.getUpdateID() || var_196 != param1.scale || var_149 != _loc4_.getUpdateID();
         ...
         if(_loc20_ || _loc21_)
         {
            ...
            if(var_538 != _loc7_)
            {
               for each(_loc49_ in var_387.getKeys())
               {
                  var_387.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_802.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_387.remove(_loc5_);
               var_387.add(_loc5_,_loc6_);
               var_538 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_290);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_215) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_215);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_613);
            _loc6_.appendAction(AvatarAction.const_628,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_34)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_387);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_280,AvatarAction.const_1164[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_954);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_860,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_930);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_821);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_891,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_707);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_669);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_845,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_929,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_370);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_450) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_541);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_408);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_848);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_626,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1608);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_795))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_802.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_268 = _loc3_.getUpdateID();
            var_149 = _loc4_.getUpdateID();
            var_196 = param1.scale;
            var_803.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_803)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
