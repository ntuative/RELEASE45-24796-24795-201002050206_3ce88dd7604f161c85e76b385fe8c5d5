package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_809);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_861)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_918);
               var_456 = const_1066;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_215);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_268 != _loc3_.getUpdateID() || var_196 != param1.scale || var_149 != _loc4_.getUpdateID();
         ...
         if(_loc15_ || _loc16_)
         {
            ...
            if(var_538 != _loc7_)
            {
               for each(_loc36_ in var_387.getKeys())
               {
                  var_387.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_290);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_215);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_613);
            _loc6_.appendAction(AvatarAction.const_628,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_387);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_280,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_450) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1067;
            ...
            _loc31_ = getSprite(const_1608);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_802.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_803.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_803)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
