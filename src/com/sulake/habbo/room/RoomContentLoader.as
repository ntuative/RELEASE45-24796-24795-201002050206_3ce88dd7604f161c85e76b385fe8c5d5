package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_721:String = "selection_arrow";
      ...
      private static const const_320:String = "place_holder";
      
      private static const const_1020:String = const_320;
      ...
      public static const const_515:String = "RCL_LOADER_READY";
      ...
      private var var_896:IEventDispatcher = null;
      ...
      private var var_153:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_421 = [];
         _wallItems = [];
         var_1601 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1605 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_353 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_288,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_355 != null)
         {
            _loc2_ = var_355.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_153 != null && var_153.hasWorldType(const_258 + param1))
         {
            return var_153.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_420.add(_loc10_,_loc11_);
                              if(var_421.indexOf(_loc14_) < 0)
                              {
                                 var_421.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_353 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_353.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_305 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_305.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_353.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_513.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_353.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_320,const_467,ROOM_CONTENT,const_722,const_721];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1601.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_141 && _loc5_ != RoomObjectLogicEnum.const_105)
         {
            _loc6_ = "@shadow";
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_153 != null && (var_153.type == param1 || var_153.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1020;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_514.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_354 != null)
         {
            _loc2_ = var_354.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1150);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1605.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1079.add(_loc5_,_loc8_);
               var_153 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_288,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_356,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(param1 == "user")
         {
            return RoomObjectCategoryEnum.const_18;
         }
         if(param1 == "pet")
         {
            return RoomObjectCategoryEnum.const_18;
      ...
      private function continueInitilization() : void
      {
         if(var_1602)
         {
            ...
            if(var_896 != null)
            {
               var_896.dispatchEvent(new Event(const_515));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_153 != null)
         {
            return var_153.getWorldHeightScale(const_258 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_15,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_27,furniDataLoadedHandler);
            var_896 = param1;
            var_1606 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1603 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1604 = param2.getKey("public.room.dynamic.download.url","");
            var_1607 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_29 = const_723;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_305.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_354 != null)
         {
            var_354.remove(param1);
            var_354.add(param1,param2);
         }
         if(var_355 != null)
         {
            var_355.remove(param2);
            var_355.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_141 && _loc5_ != RoomObjectVisualizationEnum.const_105)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_258 + param1) == RoomObjectCategoryEnum.const_40)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1079.getValue(param1) != null)
         {
            var_153 = var_1079.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_366,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_153 != null)
         {
            return var_153.getWorldScale(const_258 + param1);
         }
         return 32;
      }
