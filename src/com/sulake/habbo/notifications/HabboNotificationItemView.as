package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_328:int = 0;
      
      private static const const_327:Number = 50;
      
      public static const const_610:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1248 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1248 = 15;
         }
         var_1499 = _window.height;
         var_561 = 4;
         var_399 = 0;
         var_29 = const_328;
         var_192 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1248;
         if(_window.height < var_1499)
         {
            _window.height = var_1499;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_29)
         {
            ...
            case const_449:
               var_826 += param1;
               _loc2_ = Number(var_826) / Number(var_400["time_fade_in"]);
               if(var_826 > int(var_400["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_747:
               var_997 += param1;
               if(var_997 > int(var_400["time_display"]) && !var_1249)
               {
                  startFadeOut();
               }
               break;
            case const_746:
               var_825 += param1;
               _loc3_ = 1 - Number(var_825) / Number(var_400["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_825 > int(var_400["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_192.orientation == "TOP" ? int(const_327) : 0;
         var _loc4_:int = var_192.orientation == "BOTTOM" ? int(_loc2_.height - const_327) : int(_loc2_.height);
         var _loc5_:int = var_192.orientation == "LEFT" ? int(const_327) : 0;
         var _loc6_:int = var_192.orientation == "RIGHT" ? int(_loc2_.width - const_327) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
