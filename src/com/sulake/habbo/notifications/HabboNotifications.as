package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1103:String = "badges";
      
      private static const const_1100:String = "pixelbalance";
      
      private static const const_1102:String = "credits";
      
      private static const const_1098:String = "inventory";
      
      private static const const_1099:String = "friendlist";
      
      private static const const_1101:String = "selectfurni";
      
      private static const const_1097:String = "selectbadge";
      ...
      private var var_1297:IHabboToolbar;
      ...
      private var var_697:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_863);
         }
         var _loc6_:Map = var_863["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_697 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,var_74);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_820)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1181);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2188)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_990);
            var_2188 = true;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc2_,NotificationType.const_1208);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1076.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_34);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         if(param2.type == WindowEvent.const_144 || param2.type == WindowEvent.const_565)
         {
            param1.dispose();
         }
      }
      ...
      {
         var _loc1_:Array = var_1037.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1076.createPetImage(_loc2_.figure,AvatarScaleType.const_34);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               else if(_loc15_.productType == CatalogPageMessageProductData.const_60)
               {
               ...
               switch(_loc15_.productType)
               {
                  case CatalogPageMessageProductData.const_59:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_60:
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_990,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1076.createAvatarImage(param2,AvatarScaleType.const_34);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1037.push(_loc8_);
         return var_1037.length;
      }
      ...
      {
         var_1297 = IHabboToolbar(param2);
         var_1297.events.addEventListener(HabboToolbarEvent.const_66,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_509.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_787);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_787);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_263;
            }
            if(param2 == 3002)
            {
               return FurniCategory.const_281;
            }
            if(param2 == 4057)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_66)
         {
            ...
            var_408 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_863["styles"],var_863["view"],var_1297);
            ...
            var_509.events.addEventListener(BadgeImageReadyEvent.const_102,onBadgeImage);
            var_1297.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
