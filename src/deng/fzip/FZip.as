package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return !!var_39 ? 0 : uint(0);
      }
      
      public function getFileAt(param1:uint) : FZipFile
      {
         return !!var_39 ? var_39[param1] as FZipFile : null;
      }
      ...
      public function addFileFromStringAt(param1:uint, param2:String, param3:String, param4:String = "utf-8") : FZipFile
      {
         ...
         if(param1 >= var_39.length)
         {
            var_39.push(_loc5_);
         }
         else
         {
            var_39.splice(param1,0,_loc5_);
         }
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_495 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         var_87.removeEventListener(Event.COMPLETE,defaultHandler);
         var_87.removeEventListener(Event.OPEN,defaultHandler);
         var_87.removeEventListener(HTTPStatusEvent.HTTP_STATUS,defaultHandler);
         var_87.removeEventListener(IOErrorEvent.IO_ERROR,defaultErrorHandler);
         var_87.removeEventListener(SecurityErrorEvent.SECURITY_ERROR,defaultErrorHandler);
         var_87.removeEventListener(ProgressEvent.PROGRESS,progressHandler);
      }
      ...
      {
         var_87.addEventListener(Event.COMPLETE,defaultHandler);
         var_87.addEventListener(Event.OPEN,defaultHandler);
         var_87.addEventListener(HTTPStatusEvent.HTTP_STATUS,defaultHandler);
         var_87.addEventListener(IOErrorEvent.IO_ERROR,defaultErrorHandler);
         var_87.addEventListener(SecurityErrorEvent.SECURITY_ERROR,defaultErrorHandler);
         var_87.addEventListener(ProgressEvent.PROGRESS,progressHandler);
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_529))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_529,e.message));
         }
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && false)
         {
            ...
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < var_39.length)
            {
               _loc8_ = var_39[_loc7_] as FZipFile;
               if(_loc8_ != null)
               {
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_87 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_529,"EOF"));
            }
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         if(!var_87 && parseFunc == parseIdle)
         {
            var_87 = new URLStream();
            var_87.endian = Endian.LITTLE_ENDIAN;
            addEventHandlers();
            var_39 = [];
            var_131 = new Dictionary();
            parseFunc = parseSignature;
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_495.parse(param1))
         {
            ...
            dispatchEvent(new FZipEvent(FZipEvent.const_1338,var_495));
            var_495 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_39 != null && var_131 != null && param1 < var_39.length)
         {
            _loc2_ = var_39[param1] as FZipFile;
            if(_loc2_ != null)
            {
      ...
      {
         return addFileAt(!!var_39 ? 0 : uint(0),param1,param2);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8") : FZipFile
      {
         return addFileFromStringAt(!!var_39 ? 0 : uint(0),param1,param2,param3);
      }
   }
}
